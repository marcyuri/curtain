...
function ConsentBanner({
    ...
    description = "Nous utilisons des cookies afin d'améliorer votre expérience, mesurer l'audience et personnaliser certains contenus.",
    onAccept,
    onReject,
    onSave,
}) {
    ...
    return (
        <aside className="consent-banner">
            ...
            {showSettings && (
                <div className="consent-banner__settings">
                    {Object.entries(preferences).map(([key, value]) => (
                        <label key={key} className="consent-banner__option">
